...
const MessageBox: React.FC<MessageBoxProps> = ({
    ...
    const message = clsx("text-sm w-fit overflow-hidden", isOwn ? "bg-cambridgeBlue-500 text-white" : "bg-gray-100", data.image ? "rounded-md p-0" : "rounded-full py-2 px-3");
        ...
        <div className={container}>
            ...
            <div className={body}>
                ...
                {isLast && isOwn && seenList.length > 0 && (
                    <div className="text-xs font-light text-ashGray-500">
                        {`Seen by ${seenList}`}
                    </div>
                )}
            </div>
